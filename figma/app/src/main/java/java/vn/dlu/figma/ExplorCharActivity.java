...
public class ExplorCharActivity extends AppCompatActivity implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.explor_char);
        ...
        setClickListenerForViews(findViewById(android.R.id.content), R.id.kh_m_ph_, R.id.b__s_u_t_p,
                R.id.shopping_cart,R.id.notifications_active,R.id.dacnhantam,R.id.trang_ch_);
    }
    ...
    private void startNewActivity(Class<?> destinationClass) {
        startActivity(new Intent(ExplorCharActivity.this, destinationClass));
