...
public class thanhtoan_vat extends AppCompatActivity implements View.OnClickListener {

@Override
protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.thanh_toan_vat);
        ...
        R.id.shopping_cart,R.id.notifications_active,R.id.dacnhantam,R.id.back);
        }
...
private void startNewActivity(Class<?> destinationClass) {
        startActivity(new Intent(thanhtoan_vat.this, destinationClass));
