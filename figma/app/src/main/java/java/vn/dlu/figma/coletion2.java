...
public class coletion2 extends AppCompatActivity  implements View.OnClickListener {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.colection_2);
        ...
        setClickListenerForViews(findViewById(android.R.id.content), R.id.kh_m_ph_, R.id.b__s_u_t_p,
                R.id.shopping_cart, R.id.cat, R.id.dacnhantam,R.id.trang_ch_);
    }
    ...
    private void startNewActivity(Class<?> destinationClass) {
        startActivity(new Intent(coletion2.this, destinationClass));
